...
tape( 'a module instance has a `main` method calculates the sum of strided array elements (ignoring NaN values)', function test( t ) {
	var mem;
	var mod;
	var xp;
	var y;
...
tape( 'a module instance has a `main` method which returns the sum of the first element repeated N times', function test( t ) {
	var mem;
	var mod;
	var xp;
	var y;
