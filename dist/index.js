...
var O=require('@stdlib/assert-is-wasm-memory/dist'),y=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),S=require('@stdlib/utils-inherit/dist'),q=require('@stdlib/wasm-module-wrapper/dist'),g=require('@stdlib/error-tools-fmtprodmsg/dist'),j=p();function i(e){if(!(this instanceof i))return new i(e);if(!O(e))throw new TypeError(g('nullH0',e));return q.call(this,j,e,{env:{memory:e}}),this}S(i,q);y(i.prototype,"main",function(r,a,t){return this._instance.exports.stdlib_strided_dnanasumors(r,a,t)});y(i.prototype,"ndarray",function(r,a,t,o){return this._instance.exports.stdlib_strided_dnanasumors_ndarray(r,a,t,o)});m.exports=i
